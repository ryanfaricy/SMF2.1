...
<head>';
	...
	if ($context['right_to_left'])
		echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/rtl', $context['theme_variant'], '.css" />';
		...
		<div id="content_inner">
			<div id="user_tools">
				...
				if ($context['user']['is_logged'])
				{
					...
					echo '
						<p class="memb_greeting">', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></p>';
					...
					echo '
						...
						if ($context['allow_pm'])
						echo '
							<li><a class="first" href="', $scripturl, '?action=pm">', $txt['pm'], ' ', $context['user']['messages'], ' - ', $context['user']['unread_messages'] , ' ', $txt['new'], '</a></li>';
				...
				{
					echo '<div class="login_notice">', sprintf($txt['welcome_guest'], $txt['guest_title']), '</div>';
				}
...
function template_body_below()
{
	global $context, $settings, $options, $scripturl, $txt, $modSettings;
		...
		echo '
			<div id="footer">
				<ul class="reset">
					<li>newBalance by <a href="http://www.dzinerstudio.com" target="_blank">DzinerStudio</a></li>				
