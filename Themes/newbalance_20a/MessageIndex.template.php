	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		foreach ($context['boards'] as $board)
		{
			...
			// Show some basic information about the number of posts, etc.
					...
					echo '
					<td class="windowbg redirects" valign="middle" align="center" colspan="2" width="14%"><span>', $board['posts'], '</span> ', $txt['redirects'], '</td>';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr>
					...
					<td class="subject ', $alternate_class, '">
						...
						<span class="subject_title" id="msg_' . $topic['first_post']['id'] . '">', $topic['first_post']['link'], (!$context['can_approve_posts'] && !$topic['approved'] ? '&nbsp;<em>(' . $txt['awaiting_approval'] . ')</em>' : ''), '</span>';
			...
			echo '
					...
					<td class="stats ', $color_class, '">
						<span>', $topic['replies'], '</span> / <span>', $topic['views'], '</span>
					</td>
					<td class="lastpost ', $alternate_class, '">
						<span class="largertext">', $txt['by'], ' ', $topic['last_post']['member']['link'], '</span><a href="', $topic['last_post']['href'], '"><img src="', $settings['images_url'], '/icons/last_post.gif" alt="', $txt['last_post'], '" title="', $txt['last_post'], '" /></a><br />
